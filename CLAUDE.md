...
After changing source files or container skills, rebuild and restart the service for changes to take effect:
...
In this setup, the agent is running in the Host Mode - not in Docker